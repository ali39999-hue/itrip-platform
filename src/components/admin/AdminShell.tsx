...
import {
  ...
  Building2, Boxes, PanelLeftClose, PanelLeftOpen, FolderKanban, Users
} from 'lucide-react';
...
export function AdminShell({
  ...
  return (
    <div className="min-h-screen bg-soft/40 flex flex-col">
      ...
      <header className="h-16 border-b border-line bg-surface sticky top-0 z-40 px-4 md:px-8 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div className="w-9 h-9 rounded-xl bg-brand text-surface grid place-items-center shadow-xs">
      ...
      <div className="flex-1 max-w-[1440px] w-full mx-auto px-4 md:px-8 py-6">
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          {/* Sidebar */}
          <aside className={`transition-all duration-200 shrink-0 w-full ${collapsed ? 'lg:w-20' : 'lg:w-60'}`}>
            <div className="bg-surface rounded-2xl border border-line p-3 lg:sticky top-20 shadow-xs">
              {!collapsed && (
                ...
                {NAV.map((n) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs sm:text-sm font-black transition whitespace-nowrap ${
