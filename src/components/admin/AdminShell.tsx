...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { href: '/admin/content?tab=tours', label: { fa: 'تورهای مسافرتی', en: 'Tours & Packages', ar: 'الجولات السياحية', zh: '旅游线路', ru: 'Туры и пакеты' }, icon: Compass, perm: 'catalog:hotels:edit' },
