...
export function Logo({ variant = 'full', size = 'md', className = '', hideTextOnMobile = false }: LogoProps) {
  ...
  return (
    <Link
      href="/"
      className={`min-h-[44px] min-w-[44px] inline-flex items-center gap-2.5 group focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none rounded-xl p-1 -m-1 transition-all ${className}`}
