      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="bg-soft/50 p-5 md:p-6 flex flex-col justify-between items-stretch border-t md:border-t-0 md:border-s border-line w-full md:w-64 shrink-0">
          ...
          <button
            type="button"
            onClick={onSelect}
            className="w-full h-11 px-5 rounded-xl bg-action hover:bg-action-hover text-ink font-black text-xs md:text-sm flex items-center justify-center transition shadow-sm hover:shadow-elev-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand active:scale-[0.98]"
          >
            {t('selectTicket')}
          </button>
        </div>
