...
export function JalaliDatePicker({
  ...
  return (
    <div
      className={`relative w-full min-h-[50px] sm:min-h-[58px] px-3.5 py-1.5 sm:py-2 rounded-xl sm:rounded-2xl bg-surface border transition flex items-center gap-2.5 ${
        error
