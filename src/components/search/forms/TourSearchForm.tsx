...
export function TourSearchForm({
  ...
  return (
    <>
      ...
      {/* Tour Type Selection */}
      <div className="col-span-1 sm:col-span-6 lg:col-span-4 relative min-h-[50px] sm:min-h-[58px] px-3.5 py-1.5 sm:py-2 rounded-xl sm:rounded-2xl bg-surface border border-line/80 hover:border-brand focus-within:border-brand focus-within:ring-2 focus-within:ring-brand flex items-center gap-2.5 transition">
      ...
      <button
        type="submit"
        className="col-span-1 sm:col-span-12 lg:col-span-3 min-h-[50px] sm:min-h-[58px] px-6 rounded-xl sm:rounded-2xl bg-action hover:bg-action-hover text-ink text-[15px] font-black shadow-elev-1 hover:shadow-elev-2 active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
      >
        <Search size={18} />
