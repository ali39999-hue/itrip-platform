...
export function HotelCompareModal({
  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl max-h-[90vh] bg-surface rounded-t-3xl sm:rounded-3xl border-t sm:border border-line shadow-elev-3 flex flex-col overflow-hidden pb-[env(safe-area-inset-bottom)] sm:pb-0">
        ...
        <div className="px-5 sm:px-6 py-4 border-b border-line flex items-center justify-between bg-surface/90">
          <div>
            <h3 id="hotel-compare-modal-title" className="text-base sm:text-lg font-black text-ink">
              {lt(locale, {
