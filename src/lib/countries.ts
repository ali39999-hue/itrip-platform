...
export const COUNTRIES: Record<CountryId, CountryConfig> = {
  ...
  uae: {
    ...
    signatureExperiences: [
      ...
      X('گلوبال ویلج دبی', 'Global Village Dubai', 'غرفه‌های فرهنگی، خرید و غذا از بیش از ۹۰ کشور', 'Culture pavilions, shopping and street food from 90+ countries', 'festival', 'دبی', 'Dubai', 'اکتبر تا آوریل', 'Oct–Apr', 25000000),
