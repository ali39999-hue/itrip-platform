...
export function FinanceClientPage({
  ...
  const formattedTransactions: Transaction[] = transactions.map((t: any) => ({
    ...
    wallet: t.account?.ownerType,
    resultWallet: t.account?.currency,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {([
          ['IRR', lt(locale, { fa: 'صندوق ریالی', en: 'Rial Treasury', ar: 'خزينة الريال', zh: '里亚尔金库', ru: 'Риалевая казна' }), (balances?.IRR || 0).toLocaleString(numFmt), lt(locale, { fa: 'تومان', en: 'Toman', ar: 'تومان', zh: '图曼', ru: 'Toman' })],
          ...
          ['AED', lt(locale, { fa: 'صندوق درهم', en: 'AED Treasury', ar: 'خزينة الدرهم', zh: '迪拉姆金库', ru: 'Дирхамная казна' }), (balances?.AED || 0).toLocaleString(numFmt), 'AED'],
