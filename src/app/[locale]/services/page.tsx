...
export default function ServicesPage() {
  ...
  const MAIN_SERVICES = [
    ...
    { title: lt(locale, { fa: 'ترانسفر فرودگاهی', en: 'Airport Transfers', ar: 'نقل المطار', zh: '机场接送', ru: 'Трансфер из аэропорта' }), desc: lt(locale, { fa: 'خودرو با راننده در ۶ کشور', en: 'Chauffeured cars in 6 countries', ar: 'سيارات مع سائق في 6 دول', zh: '6 国专车接送', ru: 'Авто с водителем в 6 странах' }), icon: CarFront, href: '/transfers', bg: 'bg-brand/15 text-brand' },
