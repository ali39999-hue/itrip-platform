      ...
      <main className="flex-1 flex flex-col gap-6 print:w-full">
        ...
        {cancelModal && (
          <div className="fixed inset-0 z-[200] bg-deep/60 backdrop-blur-xs flex items-end sm:items-center justify-center p-0 sm:p-4 animate-in fade-in duration-200">
            <div className="w-full max-w-md bg-surface rounded-t-3xl sm:rounded-3xl p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] sm:pb-6 border-t sm:border border-line shadow-elev-3 space-y-4 max-h-[90vh] overflow-y-auto">
