                  ...
                  names: {
                    ...
                    ...(data.firstNameFa || data.lastNameFa
                      ? {
                          fa: {
                            firstName:
                              data.firstNameFa ?? s.user.names.fa.firstName,
                            lastName:
                              data.lastNameFa ?? s.user.names.fa.lastName,
                          },
                        }
                      : {}),
                    ...(data.firstNameEn || data.lastNameEn
                      ? {
                          en: {
                            firstName:
                              data.firstNameEn ?? s.user.names.en.firstName,
                            lastName:
                              data.lastNameEn ?? s.user.names.en.lastName,
                          },
                        }
                      : {}),
                  },
