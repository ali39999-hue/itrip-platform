# راهنمای جامع معماری و راه‌اندازی داکر پروژه فیروزه (Firuzo / iTrip Platform)

این سند برای مدیران فنی، تیم DevOps و توسعه‌دهندگان آماده شده است و ساختار، سناریوها، نحوه پیکربندی و بهترین روش‌های کار با داکر (Docker & Docker Compose) در پلتفرم فیروزه را توضیح می‌دهد.
